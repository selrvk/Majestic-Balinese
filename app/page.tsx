        ...
        <div className="grid justify-items-stretch">
          <div className="relative w-full">
            ...
            <img
              ...
              className="z-1 opacity-60 object-cover w-full h-[400px] sm:h-[500px] md:h-[600px] lg:h-[800px] xl:h-[900px] 2xl:h-[1000px] brightness-75"
            />
            ...
            <motion.h1
              ...
              className="absolute top-[5%] left-5 sm:top-[5%] sm:left-10 md:top-[10%] md:left-20 lg:top-[5%] lg:left-20 xl:top-[0%] xl:left-20 2xl:top-[-10%] 2xl:left-20 z-20 text-amber-100 font-italianno text-[25vw]"
            >
              Majestic
            </motion.h1>
            ...
            <motion.h1
              ...
              className="absolute top-[40%] right-5 sm:top-[50%] sm:right-10 md:top-[50%] md:right-20 lg:top-[40%] lg:right-20 xl:top-[30%] xl:right-20 2xl:top-[25%] 2xl:right-20 z-30 text-amber-100 font-italianno text-[25vw]"
            >
              Balinese
            </motion.h1>
